...
submit.addEventListener('click', function(e){
    ...
    createLabel.innerText = 'How do you feel?';
    ...
    creatButton1.addEventListener('click', function(){
        ...
        creatP.innerText = 'so, before you explain your problem, I recommend you to first [if you are sitting ,stand up] and move for 2 minutes ';
